...
| Commit | 日期 | 类型 | 说明 |
|--------|------|------|------|
| `aee864d` | 2026-08-01 | docs | 新增 GIT_COMMITS.md 提交记录文档与 AGENTS.md 维护规则 |
...
### `aee864d` 2026-08-01 — 新增提交记录文档与维护规则
- 新建 `GIT_COMMITS.md`：记录全部历史提交（本文件即本 commit 引入）。
- 新建 `AGENTS.md`：沉淀维护规则，后续每次提交推送都必须先更新 `GIT_COMMITS.md` 再随代码一起提交。
...
_最后一次更新：2026-08-01（commit `aee864d`）_
